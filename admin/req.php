                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="delete_handler.php" method="POST">
                                                        <!-- Change action URL to your delete handler script -->
                                                        <a href="javascript:void(0);" onclick="confirmDelete(this)">
                                                            <button name="Delete" class="btn btn-primary mb-2">Delete</button>
                                                        </a>
                                                ...
                                                <td>
                                                    <a href="print.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Print</a>
                                                </td>
                                            </tr>
                                            <?php
