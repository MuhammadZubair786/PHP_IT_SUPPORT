            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Here, you can view the status of pending Issue's</h6>
                </div>
       ...
       <div class="col-lg-3 col-md-6 col-12">
              <div class="card card-sm-3">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                    <?php
$query = "SELECT * FROM message  where mes_type='subadmin' OR mes_type='pending'"; 
